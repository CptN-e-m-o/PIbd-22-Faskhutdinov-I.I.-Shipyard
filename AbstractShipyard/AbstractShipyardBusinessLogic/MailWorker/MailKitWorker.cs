...
namespace AbstractShipyardBusinessLogic.MailWorker
{
    public class MailKitWorker : AbstractMailWorker
    {
        private IClientStorage _clientStorage;
        public MailKitWorker(IMessageInfoLogic messageInfoLogic, IClientStorage clientStorage) : base(messageInfoLogic) { _clientStorage = clientStorage; }
